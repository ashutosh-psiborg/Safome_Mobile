...
const LoginScreen = () => {
  ...
  GoogleSignin.configure({
    webClientId: '48378243530-fui39fo4d6i96kjbr3im97d86ktie61b.apps.googleusercontent.com', // client ID of type WEB for your server. Required to get the `idToken` on the user object, and for offline access.
    scopes: ['emai], // what API you want to access on behalf of the user, default is email and profile
