...
const LoginScreen = () => {
  ...
  GoogleSignin.configure({
    webClientId: '48378243530-jucsifivps4iudrrn6errofvgesq4fhv.apps.googleusercontent.com', // client ID of type WEB for your server. Required to get the `idToken` on the user object, and for offline access.
