...
const LoginScreen = () => {
  ...
  return (
    <MainBackground>
      ...
      <View style = {{marginTop:DimensionConstants.twentyFour}}>
        <Text style = {{color :'#889CA3', fontSize : 12, fontWeight : '400'}}>By clicking login you agree to recognates <Text style = {{color:'#005BBB',}}>Terms of use </Text>and <Text>Privacy policy</Text></Text>
      </View>
    </MainBackground>
  );
};
