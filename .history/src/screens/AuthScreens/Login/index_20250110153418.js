...
const LoginScreen = () => {
  ...
  GoogleSignin.configure({
    webClientId: '48378243530-abvff9r6kgh9piu0ii1ksmgh5moolonf.apps.googleusercontent.com', // client ID of type WEB for your server. Required to get the `idToken` on the user object, and for offline access.
