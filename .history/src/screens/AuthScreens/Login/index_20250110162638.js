...
const LoginScreen = () => {
  GoogleSignin.configure({
    webClientId:
      '48378243530-9al85d8c2u34sl8dv09kuermcflte4rb.apps.googleusercontent.com', // client ID of type WEB for your server. Required to get the `idToken` on the user object, and for offline access.
    scopes: ['https://www.googleapis.com/auth/drive.readonly'], // what API you want to access on behalf of the user, default is email and profile
    forceCodeForRefreshToken: false, // [Android] related to `serverAuthCode`, read the docs link below *.
    iosClientId:
      '48378243530-nros6lhrs593erqaqhtomua609p3de6h.apps.googleusercontent.com',
  });
  const signIn = async () => {
    try {
      console.log('hhhhh');
