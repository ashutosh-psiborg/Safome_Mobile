...
const LoginScreen = () => {
  ...
  GoogleSignin.configure({
    webClientId: '0ii1ksmgh5moolonf.apps.googleusercontent.com', // client ID of type WEB for your server. Required to get the `idToken` on the user object, and for offline access.
