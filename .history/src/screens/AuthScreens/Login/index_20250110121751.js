...
const LoginScreen = () => {
  ...
  return (
    <MainBackground>
      ...
      <CustomButton textColor={'black'} borderColor={'#F0F1F2'} color={'#FFFFFF'} text={ t('Continue with Google') } icon={<GoogleIcon/> } />
      </View>
      <View style = {{marginTop : DimensionConstants.ten}}>
      <CustomButton textColor={'black'} borderColor={'#F0F1F2'} color={'#FFFFFF'} text={ t('Continue with Google') } icon={<AppleIcon/> } />
      </View>
      <View style = {{marginTop:DimensionConstants.twentyFour}}>
        <Text style = {{color :'#889CA3', fontSize : 12, fontWeight : '400'}}>By clicking login you agree to recognates <Text style = {{color:'#005BBB',fontWeight : '500'}}>Terms of use </Text>and <Text style = {{color:'#005BBB',fontWeight : '500'}}>Privacy policy</Text></Text>
      </View>
    </MainBackground>
  );
};
