...
const LoginScreen = () => {
  GoogleSignin.configure({
    webClientId:
      '48378243530-pk221hjgtjnqsbdm6m032k6rifcv55nr.apps.googleusercontent.com', // client ID of type WEB for your server. Required to get the `idToken` on the user object, and for offline access.
  });
  const signIn = async () => {
    try {
      console.log('hhhhh');
