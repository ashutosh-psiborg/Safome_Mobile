...
const styles = StyleSheet.create({
  ...
  image: {
    width: DimensionConstants.twoHundred, // Replace with appropriate constant
    height: DimensionConstants.twoHundred, // Replace with appropriate constant
    resizeMode: 'contain', // Optional for better scaling
  },
  textContainer: {
    alignItems: 'center',
  },
