...
const authenticateWithBiometrics = async () => {
  ...
  try {
    ...
    if (!available) {
      Alert.alert('Biometric', 'Biometric authentication is not available on this device.');
      return;
    }

    // Inform the user about the available biometric type (optional)
  ...
  return (
    <MainBackground>
      <View>
        ...
        <CustomButton onPress={handleBiometricAuthentication} text={t('Enable')} />
        {/* <CustomButton
