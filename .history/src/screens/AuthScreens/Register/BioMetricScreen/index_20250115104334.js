  ...
  return (
    <MainBackground>
      <View>
        ...
        />
        <Text style={styles.infoText}>Experience instant access</Text>
        <Text style={styles.infoText}> No passwords, no hassle, just secure
and effortless verification</Text>
              <CustomButton
