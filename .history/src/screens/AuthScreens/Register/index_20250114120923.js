  ...
  return (
    <MainBackground>
      ...
      <View style={styles.formContainer}>
        ...
        <Text style={{fontSize: 12, lineHeight: 22, fontWeight: '400',color :'#889CA3'}}>
          By creating an account , I agree to
          <Text style={{fontSize: 12, fontWeight: '500',color : '#005BBB'}}> Terms of use </Text>
          and <Text style={{fontSize: 12, fontWeight: '500',color : '#005BBB'}}>Privacy policy</Text>
        </Text>
        <CustomButton text={'#889CA3' } />
      </View>
    </MainBackground>
  );
};
