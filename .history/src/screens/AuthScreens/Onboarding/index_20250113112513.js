...
const OnboardingScreen = ({ navigation }) => {
  const slides = [
    {
      id: '1',
      image: require('../../../assets/images/6904757 1.png'), // replace with your image path
    ...
    {
      id: '4',
      image: require('../../../assets/images/5051207 1.png'), // replace with your image path
  ...
  const handleNext = () => {
    if (currentIndex === slides.length - 1) {
      navigation.replace('HomeScreen'); // Replace 'MainScreen' with your main app screen
    } else {
